...
| [Policy creation using the WDAC Wizard UI Tool](policy-creation-with-wdac-wizard.md) | This set of topics outlines the functionality of the WDAC Wizard and its ability to create application control policies through the Wizard. |
